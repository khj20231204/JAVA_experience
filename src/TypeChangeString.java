...
public class TypeChangeString {
    public static void typeChangeStringFunc(){
        /*
       ...
       */
        ...
        System.out.println("2) int:"+i_2+" ,long:"+l_2+ " ,double:"+d_2);
        //2) int:3424 ,long:3424 ,double:3424.0
