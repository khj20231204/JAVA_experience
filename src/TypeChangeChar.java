public class TypeChangeChar {
    public static void typeChangeCharFunc() {
       /*
       char은 10이상의 숫자는 입력 안된다. 아스키코드에 있는 문자숫자가 9까지 밖에 없다.
       ...
       */
        ...
        //3.int[], long[], double[] -> char[] 필요없다
        //4.char[] -> int[], long[], double[] 필요없다
